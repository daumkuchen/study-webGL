(() => {
  ...
  window.addEventListener('load', function() {
    ...
    geometry = new THREE.SphereGeometry(2.0, 128.0, 128.0);
    // geometry = new THREE.PlaneGeometry(1.0, 1.0, 128.0, 128.0);
    ...
    // texture.load('./image.jpg', function(texture) {
    //   material = new THREE.MeshPhongMaterial({
    //     map: texture
    //   });
