...
var vertexSrc = require('./../_shader/main.vert');
var fragmentSrc = require('./../_shader/main.frag');
...
var Sample = function () {
  ...
  _createClass(Sample, [{
    ...
    value: function init() {
      ...
      // デモに使用する画像URL
      var assetUrls = ['./../img/img_01.jpg', './../img/img_02.jpg', './../img/displacement.jpg'];
      ...
      var uTransLoc = gl.getUniformLocation(program, 'uTrans');
      var textureLocArr = [];
      ...
      function loop() {
        ...
        // uniformsの値を指定する
        // 描画に使用するのtexture設定
        textureArr.forEach(function (texture, index) {
...
},{"./../_shader/main.frag":3,"./../_shader/main.vert":4,"gsap":5}],2:[function(require,module,exports){
'use strict';
...
},{"./Sample":1,"gsap":5}],3:[function(require,module,exports){
