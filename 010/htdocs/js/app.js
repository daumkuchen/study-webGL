...
(function () {
  ...
  window.addEventListener('load', function () {
    ...
    guiSphere.add(sphere, 'radius', 0.0, 2.0).onChange(function (value) {
      // mesh.geometry.dispose();
      // mesh.geometry = new THREE.SphereGeometry(value, 128.0, 128.0);
      mesh.geometry = new THREE.BoxGeometry(value, value, value);
